        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                        <h2 class="page-heading">Category :<?php echo $category ?></h2>
                        <?php
                    ...
                    <?php
                    $count_query = "SELECT * from post p left join category c on p.category = c.category_id where c.category_name = '{$category}'";
                    ...
                    if ($total_page > 1) {
                            echo "<ul class='pagination admin-pagination'>";
                            if ($page > 1) {
                                echo "<li><a href='category.php?category=" . urlencode($category) . "&page=" . ($page - 1) . "'>Prev</a></li>";
                            }
                            for ($i = 1; $i <= $total_page; $i++) {
                                $active = ($i == $page) ? "active" : "";
                                echo "<li class='$active'><a href='category.php?category=" . urlencode($category) . "&page=$i'>$i</a></li>";
                            }
                            if ($page < $total_page) {
                                echo "<li><a href='category.php?category=" . urlencode($category) . "&page=" . ($page + 1) . "'>Next</a></li>";
                            }
                            echo "</ul>";
                }} ?>
                    </div><!-- /post-container -->
